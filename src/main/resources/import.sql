...
('vlad_galakas@gmail.com', 'Vlad', 'Galakas', '1111', 'USER');
...
('epam-lab-group', 'Vlad Galakas', 666.666, 'https"//download/photo/whithout/registration/im/not/kidding/lol.png');
...
('vlad_galakas@gmail.com', 'epam-lab-group');
